...
<body>
  ...
  <script src="../../js/student-dashboard/Student-materials.js"></script> <!-- JS for materials functionality -->
 <script src="../../js/calendar.js"></script>    <!-- JS for sidebar and nav -->
